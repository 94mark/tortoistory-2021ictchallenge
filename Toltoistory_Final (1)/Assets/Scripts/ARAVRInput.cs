...
public static class ARAVRInput
{
    ...
    {
#if PC
        One = ButtonTarget.Fire1,  //왼쪽버튼
        Two = ButtonTarget.Jump,  //스페이스
        Thumbstick = ButtonTarget.Fire1,  //왼쪽버튼
        IndexTrigger = ButtonTarget.Fire3,  //휠버튼
        HandTrigger = ButtonTarget.Fire2  //오른쪽버튼
#elif Oculus
    ...
    {  //duration : 반복횟수, frequency : 지속시간, amplitude : 진동크기, hand : 왼/오른쪽 컨트롤러
#if Oculus
